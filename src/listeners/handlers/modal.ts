...
export default async function handleModal(client: Client, EraserTail: EraserTailClient, interaction: ModalSubmitInteraction, pnfxMember: PNFXMember, iNaturalist:iNatClient): Promise<void> {
